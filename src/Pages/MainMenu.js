      ...
      <>
          ...
          <main>
            <div className={styles.topOfPage}>
              ...
              <h1>Terra Testr</h1>
              <div>Observe your surroundings and make guesses as to where you are! Each game consists of 3 hints within 10km of each other and the final hint will always be a landmark. Win the game by guessing within 100km of any hint. Most importantly: Have fun!</div>
              {random ? 
